...
if __name__ == "__main__":
    ...
    with open("user_guide/src/outputs/predicate_pushdown_0.txt", "w") as f:
        f.write(str(df))

    reddit.show_graph(
        optimized=False,
        show=False,
        output_path="user_guide/src/img/predicate_pushdown_0.png",
    )
    reddit.show_graph(
        optimized=True,
        show=False,
        output_path="user_guide/src/img/predicate_pushdown_0_optimized.png",
    )
