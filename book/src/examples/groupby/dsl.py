...
if __name__ == "__main__":
    out = q.collect()
    with open("book/src/outputs/groupby_dsl_0.txt", "w") as f:
        f.write(str(out))

    out = q1.collect()
    with open("book/src/outputs/groupby_dsl_1.txt", "w") as f:
        f.write(str(out))

    out = q2.collect()
    with open("book/src/outputs/groupby_dsl_2.txt", "w") as f:
        f.write(str(out))

    out = q3.collect()
    with open("book/src/outputs/groupby_dsl_3.txt", "w") as f:
        f.write(str(out))

    out = q4.collect()
    with open("book/src/outputs/groupby_dsl_4.txt", "w") as f:
        f.write(str(out))

    out = q5.collect()
    with open("book/src/outputs/groupby_dsl_5.txt", "w") as f:
        f.write(str(out))

    out = q6.collect()
    with open("book/src/outputs/groupby_dsl_6.txt", "w") as f:
        f.write(str(out))
